...
#### Step 2:
* Go through each facility type in the sub_type column that has a score lower than 75. We want to make sure we aggregate facility types in the right way. A score lower than 100 can be misclassified. Correct the cases that you find missclassified in the sub_type column.
