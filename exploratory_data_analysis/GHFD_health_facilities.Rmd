...
+ We expect health facilities to fall on a settlement extent. The plot below summarizes facility by settlement extent type in which the facilities are located.
*Out of a settlement* indicates facilities that more thatn 250 meters from a settlment extent. Either these facilities do not have the right lat/long attribute or the settlement extent layer that we use missed some settlements. 
